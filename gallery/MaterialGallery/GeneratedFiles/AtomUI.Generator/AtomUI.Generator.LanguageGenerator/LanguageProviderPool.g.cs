...
namespace AtomUI.Theme.Language
{
    internal class LanguageProviderPool
    {
        internal static IList<LanguageProvider> GetLanguageProviders()
        {
            ...
            languageProviders.Add(new MaterialGallery.Workspace.Localization.WorkspaceWindowLang.en_US());
            languageProviders.Add(new MaterialGallery.Workspace.Localization.WorkspaceWindowLang.zh_CN());
