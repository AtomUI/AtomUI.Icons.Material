...
public class NotificationSyncDisabledRounded : MaterialIcon
{
    public NotificationSyncDisabledRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3.1799999999999997, 4.0000000000000009, 16.82, 17.030000000000005);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.1644832605531297, 0, 0, 1.1644832605531297, -1.9737991266375552, -1.9737991266375552);
