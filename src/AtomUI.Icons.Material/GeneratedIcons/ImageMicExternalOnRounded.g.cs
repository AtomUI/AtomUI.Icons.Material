...
public class ImageMicExternalOnRounded : MaterialIcon
{
    public ImageMicExternalOnRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 1.8700000000000001, 16, 20.259999999999998);
