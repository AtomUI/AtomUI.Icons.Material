...
public class ActionAlarmOffOutlined : MaterialIcon
{
    public ActionAlarmOffOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.6100000000000001, 1.8099999999999996, 20.334, 20.190000000000001);
