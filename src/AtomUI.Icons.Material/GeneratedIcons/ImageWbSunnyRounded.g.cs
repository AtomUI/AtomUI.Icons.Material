...
public class ImageWbSunnyRounded : MaterialIcon
{
    public ImageWbSunnyRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 0.55000000000000071, 21.989999999999998, 21.899999999999999);
