...
public class ImageCurrencyRubleRounded : MaterialIcon
{
    public ImageCurrencyRubleRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(5, 3, 14.289999999999999, 18);
