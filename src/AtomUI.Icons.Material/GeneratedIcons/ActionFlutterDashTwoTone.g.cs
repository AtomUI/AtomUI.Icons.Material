...
public class ActionFlutterDashTwoTone : MaterialIcon
{
    public ActionFlutterDashTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 1.5, 20, 21.500000000000004);
