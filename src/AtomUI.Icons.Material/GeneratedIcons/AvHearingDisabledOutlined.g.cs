...
public class AvHearingDisabledOutlined : MaterialIcon
{
    public AvHearingDisabledOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.3899999999999999, 1.2199999999999998, 19.800000000000001, 21.389999999999997);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.0535557506584723, 0, 0, 1.0535557506584723, -0.64266900790166659, -0.64266900790166659);
