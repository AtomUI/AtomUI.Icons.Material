...
public class MapsTheaterComedyRounded : MaterialIcon
{
    public MapsTheaterComedyRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 2, 22, 20.420000000000002);
