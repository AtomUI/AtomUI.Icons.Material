...
public class PlacesNoStrollerFilled : MaterialIcon
{
    public PlacesNoStrollerFilled()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.3899999999999999, 2.7200000000000006, 20.609999999999999, 19.890000000000001);
