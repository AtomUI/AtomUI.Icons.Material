...
public class FileFileDownloadOffRounded : MaterialIcon
{
    public FileFileDownloadOffRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.7099999999999995, 3, 19.169999999999998, 19.289999999999999);
