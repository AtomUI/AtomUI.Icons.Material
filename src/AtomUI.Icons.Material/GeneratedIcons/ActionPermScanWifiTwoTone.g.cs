...
public class ActionPermScanWifiTwoTone : MaterialIcon
{
    public ActionPermScanWifiTwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M12 5c-3.26 0-6.2.85-9.08 2.65L12 18.83l9.08-11.16C18.18 5.85 15.25 5 12 5zm1 11h-2v-6h2v6zm-2-8V6h2v2h-2z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
