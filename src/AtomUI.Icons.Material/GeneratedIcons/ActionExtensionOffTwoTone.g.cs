...
public class ActionExtensionOffTwoTone : MaterialIcon
{
    public ActionExtensionOffTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.3899999999999999, 1.5, 21.109999999999999, 21.099999999999998);
