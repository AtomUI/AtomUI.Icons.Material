...
public class ActionDonutLargeRounded : MaterialIcon
{
    public ActionDonutLargeRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 2.1399999999999997, 19.859999999999999, 19.720000000000002);
