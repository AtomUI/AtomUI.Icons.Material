...
public class NavigationMenuOpenRounded : MaterialIcon
{
    public NavigationMenuOpenRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3, 6, 17.690000000000001, 12);
