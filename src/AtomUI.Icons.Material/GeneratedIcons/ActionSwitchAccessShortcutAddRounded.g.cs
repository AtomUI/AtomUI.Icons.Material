...
public class ActionSwitchAccessShortcutAddRounded : MaterialIcon
{
    public ActionSwitchAccessShortcutAddRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3, 2, 21, 19.66);
