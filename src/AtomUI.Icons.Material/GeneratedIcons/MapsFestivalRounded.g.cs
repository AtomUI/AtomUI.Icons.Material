...
public class MapsFestivalRounded : MaterialIcon
{
    public MapsFestivalRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 2.5400000000000005, 22, 19.460000000000001);
