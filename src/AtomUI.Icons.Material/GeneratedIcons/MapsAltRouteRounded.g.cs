...
public class MapsAltRouteRounded : MaterialIcon
{
    public MapsAltRouteRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3.54, 2.1499999999999999, 16.920000000000002, 19.850000000000001);
