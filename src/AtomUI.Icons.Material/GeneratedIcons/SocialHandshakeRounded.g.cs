...
public class SocialHandshakeRounded : MaterialIcon
{
    public SocialHandshakeRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.700000000000002, 2.7099999999999991, 20.600000000000001, 18.380000000000003);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.0762331838565027, 0, 0, 1.0762331838565027, -0.91479820627803221, -0.91479820627803221);
