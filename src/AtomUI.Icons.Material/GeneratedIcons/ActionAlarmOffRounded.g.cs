...
public class ActionAlarmOffRounded : MaterialIcon
{
    public ActionAlarmOffRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.9099999999999993, 2.0900000000000003, 19.760000000000002, 19.91);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.0864644635581711, 0, 0, 1.0864644635581711, -1.0375735626980536, -1.0375735626980536);
