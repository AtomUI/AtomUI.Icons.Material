...
public class PlacesFenceRounded : MaterialIcon
{
    public PlacesFenceRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3, 4.3200000000000003, 18, 15.68);
