...
public class FileCloudSyncTwoTone : MaterialIcon
{
    public FileCloudSyncTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 4, 20, 16);
