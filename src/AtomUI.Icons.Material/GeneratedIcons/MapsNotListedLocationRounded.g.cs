...
public class MapsNotListedLocationRounded : MaterialIcon
{
    public MapsNotListedLocationRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 2, 16, 19.75);
