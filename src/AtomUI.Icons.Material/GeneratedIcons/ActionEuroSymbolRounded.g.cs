...
public class ActionEuroSymbolRounded : MaterialIcon
{
    public ActionEuroSymbolRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3, 3, 17.57, 18);
