...
public class ActionPinchRounded : MaterialIcon
{
    public ActionPinchRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 1, 22.100000000000001, 22);
