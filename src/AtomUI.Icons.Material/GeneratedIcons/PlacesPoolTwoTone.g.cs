...
public class PlacesPoolTwoTone : MaterialIcon
{
    public PlacesPoolTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.9999999999999982, 2.9900000000000002, 20, 18.009999999999998);
