...
public class DeviceHdrOffSelectSharp : MaterialIcon
{
    public DeviceHdrOffSelectSharp()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(0, 0.16999999999999993, 24, 21.829999999999998);
