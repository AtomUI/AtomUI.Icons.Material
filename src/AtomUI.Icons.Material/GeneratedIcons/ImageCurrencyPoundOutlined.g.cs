...
public class ImageCurrencyPoundOutlined : MaterialIcon
{
    public ImageCurrencyPoundOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(6, 2.5, 12, 18.5);
