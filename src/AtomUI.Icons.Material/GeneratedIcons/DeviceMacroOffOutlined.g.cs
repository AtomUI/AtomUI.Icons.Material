...
public class DeviceMacroOffOutlined : MaterialIcon
{
    public DeviceMacroOffOutlined()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        ...
        new PathDrawingInstruction()
        {
            Opacity = 1,
            FillBrush = IconBrushType.Stroke,
            Data = StreamGeometry.Parse("M19.98,17.15C20.63,15.91,21,14.5,21,13c-1.5,0-2.91,0.37-4.15,1.02L19.98,17.15z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
