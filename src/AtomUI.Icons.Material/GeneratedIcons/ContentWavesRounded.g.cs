...
public class ContentWavesRounded : MaterialIcon
{
    public ContentWavesRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.9999999999999987, 3.6599999999999993, 20.000000000000004, 16.690000000000001);
