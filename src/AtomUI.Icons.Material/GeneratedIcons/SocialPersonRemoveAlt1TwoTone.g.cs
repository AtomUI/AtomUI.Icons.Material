...
public class SocialPersonRemoveAlt1TwoTone : MaterialIcon
{
    public SocialPersonRemoveAlt1TwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M10,16c2.69,0,5.77,1.28,6,2H4C4.2,17.29,7.3,16,10,16z"),
        },
