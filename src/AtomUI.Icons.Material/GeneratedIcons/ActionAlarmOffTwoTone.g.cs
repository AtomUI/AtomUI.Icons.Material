...
public class ActionAlarmOffTwoTone : MaterialIcon
{
    public ActionAlarmOffTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.6099999999999997, 1.8099999999999996, 20.334, 20.190000000000001);
