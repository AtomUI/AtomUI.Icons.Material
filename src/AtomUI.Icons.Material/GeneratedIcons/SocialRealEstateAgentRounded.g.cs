...
public class SocialRealEstateAgentRounded : MaterialIcon
{
    public SocialRealEstateAgentRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 1.8300000000000005, 21.009999999999998, 20.169999999999998);
