...
public class MapsDryCleaningRounded : MaterialIcon
{
    public MapsDryCleaningRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3, 1.78, 18, 20.219999999999999);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.0801080108010801, 0, 0, 1.0801080108010801, -0.96129612961296118, -0.96129612961296118);
