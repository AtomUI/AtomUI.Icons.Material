...
public class SocialScubaDivingRounded : MaterialIcon
{
    public SocialScubaDivingRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 2.23, 21.809999999999999, 20.499999999999996);
