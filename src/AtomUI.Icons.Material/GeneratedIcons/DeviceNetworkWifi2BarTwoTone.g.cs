...
public class DeviceNetworkWifi2BarTwoTone : MaterialIcon
{
    public DeviceNetworkWifi2BarTwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M16.78,13.38C15.4,12.5,13.76,12,12,12c-1.76,0-3.4,0.5-4.78,1.38l-4.3-4.3C5.51,7.08,8.67,6,12,6 s6.49,1.08,9.08,3.07L16.78,13.38z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
