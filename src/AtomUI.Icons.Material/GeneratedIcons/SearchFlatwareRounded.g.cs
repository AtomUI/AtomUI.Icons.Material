...
public class SearchFlatwareRounded : MaterialIcon
{
    public SearchFlatwareRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3, 2.9900000000000002, 18, 18.009999999999998);
