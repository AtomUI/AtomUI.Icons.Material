...
public class SocialRemoveModeratorRounded : MaterialIcon
{
    public SocialRemoveModeratorRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.7099999999999995, 2.0999999999999996, 19.169999999999998, 20.190000000000005);
