...
public class ActionSwipeRightTwoTone : MaterialIcon
{
    public ActionSwipeRightTwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M17.08,21h-6.55l-3.7-3.78L11,18.11V7.5C11,7.22,11.22,7,11.5,7S12,7.22,12,7.5v6.18h1.76L18,15.56L17.08,21 z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
