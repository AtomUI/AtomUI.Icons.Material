...
public class SocialSocialDistanceOutlined : MaterialIcon
{
    public SocialSocialDistanceOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 3, 20, 17.990000000000002);
