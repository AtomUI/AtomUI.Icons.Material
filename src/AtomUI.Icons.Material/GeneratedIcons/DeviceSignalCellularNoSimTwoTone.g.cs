...
public class DeviceSignalCellularNoSimTwoTone : Icon
{
    public DeviceSignalCellularNoSimTwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M10.83 5L9.36 6.47 17 14.11V5zM7 9.79V19h9.23z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
