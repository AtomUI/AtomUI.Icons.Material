...
public class DevicePunchClockTwoTone : Icon
{
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        ...
        new PolygonDrawingInstruction()
        {
            Opacity = 1,
            FillBrush = IconBrushType.Stroke,
            Points = [new Point(13.85, 15.14),new Point(12.5, 13.79),new Point(12.5, 11.5),new Point(11.5, 11.5),new Point(11.5, 14.21),new Point(13.14, 15.85)]
        },
    ];
