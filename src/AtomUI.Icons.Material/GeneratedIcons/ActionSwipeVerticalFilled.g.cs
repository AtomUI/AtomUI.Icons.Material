...
public class ActionSwipeVerticalFilled : MaterialIcon
{
    public ActionSwipeVerticalFilled()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(0, 2, 23.770000000000003, 20.200000000000003);
