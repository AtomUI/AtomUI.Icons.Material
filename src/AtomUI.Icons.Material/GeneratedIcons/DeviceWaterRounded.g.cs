...
public class DeviceWaterRounded : MaterialIcon
{
    public DeviceWaterRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 7, 20.000000000000004, 11.02);
