...
public class ActionAddTaskRounded : MaterialIcon
{
    public ActionAddTaskRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.72, 1.95, 22.280000000000001, 20.050000000000001);
