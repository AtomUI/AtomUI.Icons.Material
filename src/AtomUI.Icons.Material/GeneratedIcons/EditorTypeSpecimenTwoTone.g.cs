...
public class EditorTypeSpecimenTwoTone : MaterialIcon
{
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PolygonDrawingInstruction()
        {
            ...
            Points = [new Avalonia.Point(14.04, 7.17),new Avalonia.Point(13.96, 7.17),new Avalonia.Point(12.65, 10.89),new Avalonia.Point(15.34, 10.89)]
        },
