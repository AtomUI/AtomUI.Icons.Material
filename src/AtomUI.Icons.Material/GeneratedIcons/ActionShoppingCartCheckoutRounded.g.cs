...
public class ActionShoppingCartCheckoutRounded : MaterialIcon
{
    public ActionShoppingCartCheckoutRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 2, 19.789999999999999, 20);
