...
public class ActionBugReportRounded : MaterialIcon
{
    public ActionBugReportRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 3.3100000000000001, 16, 17.690000000000001);
