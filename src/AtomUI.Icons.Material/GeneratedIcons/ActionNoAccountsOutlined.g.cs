...
public class ActionNoAccountsOutlined : MaterialIcon
{
    public ActionNoAccountsOutlined()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M15.18,10.94c0.2-0.44,0.32-0.92,0.32-1.44C15.5,7.57,13.93,6,12,6c-0.52,0-1,0.12-1.44,0.32L15.18,10.94z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
