...
public class DeviceAirplanemodeActiveRounded : MaterialIcon
{
    public DeviceAirplanemodeActiveRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 2, 20, 19.93);
