...
public class PlacesTapasRounded : MaterialIcon
{
    public PlacesTapasRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.3600000000000001, 1, 20.640000000000001, 22);
