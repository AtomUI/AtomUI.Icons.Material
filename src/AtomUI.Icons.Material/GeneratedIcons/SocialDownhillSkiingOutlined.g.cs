...
public class SocialDownhillSkiingOutlined : MaterialIcon
{
    public SocialDownhillSkiingOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 2.5, 20, 20.5);
