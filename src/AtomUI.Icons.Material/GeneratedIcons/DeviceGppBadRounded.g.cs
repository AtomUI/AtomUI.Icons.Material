...
public class DeviceGppBadRounded : MaterialIcon
{
    public DeviceGppBadRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 2.0899999999999999, 16, 19.880000000000003);
