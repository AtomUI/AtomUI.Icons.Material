...
public class ActionSwipeRightRounded : MaterialIcon
{
    public ActionSwipeRightRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.1600000000000001, 1, 19.84, 22);
