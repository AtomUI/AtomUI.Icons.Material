...
public class PlacesNoFlashFilled : MaterialIcon
{
    public PlacesNoFlashFilled()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.04, 2, 20.960000000000001, 20.960000000000001);
