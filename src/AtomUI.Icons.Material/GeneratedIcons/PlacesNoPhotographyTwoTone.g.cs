...
public class PlacesNoPhotographyTwoTone : MaterialIcon
{
    public PlacesNoPhotographyTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(0.68000000000000016, 2.1000000000000001, 21.32, 21.209999999999997);
