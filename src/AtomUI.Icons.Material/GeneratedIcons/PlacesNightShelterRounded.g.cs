...
public class PlacesNightShelterRounded : MaterialIcon
{
    public PlacesNightShelterRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 3.3700000000000001, 16, 17.629999999999999);
