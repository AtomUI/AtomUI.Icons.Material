...
public class ActionSatelliteAltFilled : MaterialIcon
{
    public ActionSatelliteAltFilled()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(-0.19000000000000061, -0.20000000000000001, 23.190000000000001, 23.199999999999999);
