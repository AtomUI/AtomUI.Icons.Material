...
public class ImageFaceRetouchingNaturalOutlined : MaterialIcon
{
    public ImageFaceRetouchingNaturalOutlined()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        ...
        new PolygonDrawingInstruction()
        {
            Opacity = 1,
            FillBrush = IconBrushType.Stroke,
            Points = [new Avalonia.Point(23, 4.5),new Avalonia.Point(20.6, 3.4),new Avalonia.Point(19.5, 1),new Avalonia.Point(18.4, 3.4),new Avalonia.Point(16, 4.5),new Avalonia.Point(18.4, 5.6),new Avalonia.Point(19.5, 8),new Avalonia.Point(20.6, 5.6)]
        },
    ];
