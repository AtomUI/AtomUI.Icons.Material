...
public class ImageFaceRetouchingNaturalOutlined : Icon
{
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        ...
        new PolygonDrawingInstruction()
        {
            Opacity = 1,
            FillBrush = IconBrushType.Stroke,
            Points = [new Point(23, 4.5),new Point(20.6, 3.4),new Point(19.5, 1),new Point(18.4, 3.4),new Point(16, 4.5),new Point(18.4, 5.6),new Point(19.5, 8),new Point(20.6, 5.6)]
        },
    ];
