...
public class NotificationTvOffRounded : MaterialIcon
{
    public NotificationTvOffRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 1.1500000000000001, 22, 21.530000000000001);
