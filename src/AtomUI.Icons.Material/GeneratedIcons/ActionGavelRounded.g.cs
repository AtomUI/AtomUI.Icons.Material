...
public class ActionGavelRounded : MaterialIcon
{
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 1.6299999999999999, 20.580000000000002, 21.370000000000001);
