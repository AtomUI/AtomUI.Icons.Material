...
public class DeviceSettingsSuggestFilled : MaterialIcon
{
    public DeviceSettingsSuggestFilled()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.8199999999999998, 2, 21.18, 20);
