...
public class MapsSignpostSharp : MaterialIcon
{
    public MapsSignpostSharp()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3.4700000000000006, 2, 17.059999999999995, 20);
