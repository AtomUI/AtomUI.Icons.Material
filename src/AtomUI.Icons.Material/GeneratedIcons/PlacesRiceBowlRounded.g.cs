...
public class PlacesRiceBowlRounded : MaterialIcon
{
    public PlacesRiceBowlRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(0.10000000000000001, 1.95, 21.899999999999999, 20.050000000000001);
