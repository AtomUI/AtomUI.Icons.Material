...
public class DevicePasswordRounded : MaterialIcon
{
    public DevicePasswordRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 7.1600000000000001, 22, 11.84);
