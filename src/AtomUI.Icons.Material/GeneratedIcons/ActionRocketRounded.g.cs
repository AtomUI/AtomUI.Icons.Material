...
public class ActionRocketRounded : MaterialIcon
{
    public ActionRocketRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 2.6100000000000003, 16, 19.100000000000001);
