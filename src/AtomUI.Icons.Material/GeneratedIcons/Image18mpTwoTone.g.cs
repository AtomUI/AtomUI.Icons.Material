...
public class Image18mpTwoTone : MaterialIcon
{
    public Image18mpTwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new RectDrawingInstruction()
        {
            ...
            Rect = new Rect(13.5, 6.5, 1.5, 1.5),
            RadiusX = 0,
            RadiusY = 0,
        },
        new RectDrawingInstruction()
        ...
        new PathDrawingInstruction()
        {
            Opacity = 1,
            FillBrush = IconBrushType.Stroke,
            Data = StreamGeometry.Parse("M13,11.5h2.5c0.55,0,1-0.45,1-1v-4c0-0.55-0.45-1-1-1H13c-0.55,0-1,0.45-1,1v4C12,11.05,12.45,11.5,13,11.5z M13.5,6.5H15 V8h-1.5V6.5z M13.5,9H15v1.5h-1.5V9z"),
        },
    ];
