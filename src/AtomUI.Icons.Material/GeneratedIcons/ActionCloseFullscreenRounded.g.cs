...
public class ActionCloseFullscreenRounded : MaterialIcon
{
    public ActionCloseFullscreenRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.3100000000000001, 2.3100000000000001, 19.370000000000001, 19.370000000000001);
