...
public class HomeHeatPumpTwoTone : MaterialIcon
{
    public HomeHeatPumpTwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M5,19h14V5H5V19z M12,6c3.31,0,6,2.69,6,6s-2.69,6-6,6s-6-2.69-6-6S8.69,6,12,6z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
