...
public class DeviceWifiChannelRounded : MaterialIcon
{
    public DeviceWifiChannelRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3.0600000000000001, 3, 17.920000000000002, 18);
