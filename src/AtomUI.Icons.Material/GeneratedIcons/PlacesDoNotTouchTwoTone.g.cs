...
public class PlacesDoNotTouchTwoTone : MaterialIcon
{
    public PlacesDoNotTouchTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.3899999999999999, 1, 19.800000000000001, 21.600000000000005);
