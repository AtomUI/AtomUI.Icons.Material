...
public class SocialSickOutlined : MaterialIcon
{
    public SocialSickOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.1799999999999997, 2, 20.82, 20);
