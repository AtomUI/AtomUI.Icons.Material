...
public class ActionTokenRounded : MaterialIcon
{
    public ActionTokenRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3, 2.2000000000000002, 18, 19.240000000000002);
