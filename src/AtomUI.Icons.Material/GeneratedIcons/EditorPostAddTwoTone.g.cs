...
public class EditorPostAddTwoTone : MaterialIcon
{
    public EditorPostAddTwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M17,19.22H5V7h7V5H5C3.9,5,3,5.9,3,7v12c0,1.1,0.9,2,2,2h12c1.1,0,2-0.9,2-2v-7h-2V19.22z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
