...
public class DeviceUsbOffOutlined : MaterialIcon
{
    public DeviceUsbOffOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.3899999999999999, 2, 19.789999999999999, 20.599999999999998);
