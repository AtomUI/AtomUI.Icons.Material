...
public class SocialLuggageTwoTone : MaterialIcon
{
    public SocialLuggageTwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M7,8v11h10V8H7z M9.5,18H8V9h1.5V18z M12.75,18h-1.5V9h1.5V18z M16,18h-1.5V9H16V18z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
