...
public class SocialBlindTwoTone : MaterialIcon
{
    public SocialBlindTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 1.5, 17.5, 21.5);
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new CircleDrawingInstruction()
        {
            ...
            Center = new Avalonia.Point(11.5, 3.5),
            Radius = 2
        },
