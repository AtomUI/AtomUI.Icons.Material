...
public class MapsDirectionsRunRounded : MaterialIcon
{
    public MapsDirectionsRunRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.9800000000000018, 1.4800000000000004, 16.010000000000002, 21.5);
