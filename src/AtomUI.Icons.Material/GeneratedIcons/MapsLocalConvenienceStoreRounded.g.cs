...
public class MapsLocalConvenienceStoreRounded : MaterialIcon
{
    public MapsLocalConvenienceStoreRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.6399999999999999, 2.9999999999999996, 20.48, 18);
