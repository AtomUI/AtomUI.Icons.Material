...
public class SocialNoLuggageRounded : MaterialIcon
{
    public SocialNoLuggageRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.7099999999999995, 2, 19.169999999999998, 20.290000000000003);
