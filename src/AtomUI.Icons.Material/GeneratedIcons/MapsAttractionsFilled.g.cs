...
public class MapsAttractionsFilled : MaterialIcon
{
    public MapsAttractionsFilled()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.8300000000000001, 2, 18.329999999999998, 20);
