...
public class NotificationAirlineSeatReclineExtraRounded : MaterialIcon
{
    public NotificationAirlineSeatReclineExtraRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.1200000000000001, 1.7299999999999995, 19.489999999999998, 19.27);
