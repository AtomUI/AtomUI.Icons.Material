...
public class DeviceUsbRounded : MaterialIcon
{
    public DeviceUsbRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4.7999999999999998, 1.2600000000000002, 14.210000000000001, 21.249999999999996);
