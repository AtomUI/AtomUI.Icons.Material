...
public class ActionSensorsOffRounded : MaterialIcon
{
    public ActionSensorsOffRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.71, 3.1299999999999994, 20.289999999999999, 19.16);
