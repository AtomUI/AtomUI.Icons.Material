...
public class DeviceAirplanemodeInactiveRounded : MaterialIcon
{
    public DeviceAirplanemodeInactiveRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.7099999999999995, 2, 20.289999999999999, 20.289999999999999);
