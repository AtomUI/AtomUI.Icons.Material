...
public class PlacesNoFlashRounded : MaterialIcon
{
    public PlacesNoFlashRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.3600000000000003, 2, 20.470000000000002, 20.640000000000001);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.0600706713780919, 0, 0, 1.0600706713780919, -0.72084805653710227, -0.72084805653710227);
