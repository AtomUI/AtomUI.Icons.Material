...
public class EditorPolylineTwoTone : MaterialIcon
{
    public EditorPolylineTwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M12,4h2v2h-2V4z M7,14H5v-2h2V14z M19,20h-2v-2h2V20z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
