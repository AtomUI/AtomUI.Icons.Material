...
public class ActionSwitchAccessShortcutAddTwoTone : MaterialIcon
{
    public ActionSwitchAccessShortcutAddTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3, 2, 21, 20);
