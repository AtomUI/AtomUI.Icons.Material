...
public class ActionTroubleshootRounded : MaterialIcon
{
    public ActionTroubleshootRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 2.4399999999999999, 20.68, 19.239999999999998);
