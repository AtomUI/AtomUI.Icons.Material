...
public class ImageBrightness5Rounded : MaterialIcon
{
    public ImageBrightness5Rounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.0099999999999998, 1.0099999999999998, 21.980000000000004, 21.980000000000004);
