...
public class CommunicationRttRounded : MaterialIcon
{
    public CommunicationRttRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.0800000000000001, 3, 19.75, 18);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.0948905109489051, 0, 0, 1.0948905109489051, -1.1386861313868621, -1.1386861313868621);
