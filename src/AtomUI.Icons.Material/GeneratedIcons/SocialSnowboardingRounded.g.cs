...
public class SocialSnowboardingRounded : MaterialIcon
{
    public SocialSnowboardingRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.98, 1, 20.089999999999996, 21.710000000000001);
