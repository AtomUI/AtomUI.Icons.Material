...
public class ImageAutoStoriesRounded : MaterialIcon
{
    public ImageAutoStoriesRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 1.04, 22, 18.960000000000001);
