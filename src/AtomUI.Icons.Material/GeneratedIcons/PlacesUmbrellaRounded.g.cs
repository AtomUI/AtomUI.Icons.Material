...
public class PlacesUmbrellaRounded : MaterialIcon
{
    public PlacesUmbrellaRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(6.1600000000000001, 1, 11.68, 21);
