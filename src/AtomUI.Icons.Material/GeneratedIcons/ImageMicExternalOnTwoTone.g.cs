...
public class ImageMicExternalOnTwoTone : MaterialIcon
{
    public ImageMicExternalOnTwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PolygonDrawingInstruction()
        {
            ...
            Points = [new Avalonia.Point(6.81, 16),new Avalonia.Point(7.19, 16),new Avalonia.Point(7.79, 10),new Avalonia.Point(6.21, 10)]
        },
