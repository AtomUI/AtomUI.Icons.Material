...
public class PlacesHouseboatRounded : MaterialIcon
{
    public PlacesHouseboatRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 3.6800000000000006, 20, 15.34);
