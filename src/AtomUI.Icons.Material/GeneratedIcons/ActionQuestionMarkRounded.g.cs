...
public class ActionQuestionMarkRounded : MaterialIcon
{
    public ActionQuestionMarkRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(6.7800000000000002, 3, 11.099999999999998, 19);
