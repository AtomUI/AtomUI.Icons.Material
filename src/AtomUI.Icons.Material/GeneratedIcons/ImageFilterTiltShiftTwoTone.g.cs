...
public class ImageFilterTiltShiftTwoTone : MaterialIcon
{
    public ImageFilterTiltShiftTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.0499999999999998, 2.0499999999999998, 19.900000000000002, 19.899999999999999);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.0933940774487474, 0, 0, 1.0933940774487474, -1.1207289293849687, -1.1207289293849687);
