...
public class ActionSwipeVerticalRounded : MaterialIcon
{
    public ActionSwipeVerticalRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(0, 2, 23.589999999999996, 20.079999999999998);
