...
public class MapsEmergencyShareTwoTone : MaterialIcon
{
    public MapsEmergencyShareTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4.2199999999999998, 0, 15.560000000000002, 24);
