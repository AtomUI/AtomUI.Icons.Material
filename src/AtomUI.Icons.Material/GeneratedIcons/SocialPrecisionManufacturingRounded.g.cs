...
public class SocialPrecisionManufacturingRounded : MaterialIcon
{
    public SocialPrecisionManufacturingRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.7999999999999998, 2.2799999999999989, 18.309999999999999, 18.720000000000002);
