...
public class MapsModeOfTravelOutlined : MaterialIcon
{
    public MapsModeOfTravelOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 2, 19.5, 20);
