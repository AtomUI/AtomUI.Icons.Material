...
public class NotificationNetworkCheckRounded : MaterialIcon
{
    public NotificationNetworkCheckRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.4700000000000002, 3.9300000000000006, 21.059999999999999, 16.07);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.0652463382157125, 0, 0, 1.0652463382157125, -0.78295605858854955, -0.78295605858854955);
