...
public class PlacesVapeFreeRounded : MaterialIcon
{
    public PlacesVapeFreeRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.71, 2, 20.289999999999999, 20.289999999999999);
