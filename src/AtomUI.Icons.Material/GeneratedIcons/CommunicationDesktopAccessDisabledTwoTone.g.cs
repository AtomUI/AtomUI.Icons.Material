...
public class CommunicationDesktopAccessDisabledTwoTone : MaterialIcon
{
    public CommunicationDesktopAccessDisabledTwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        ...
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M2.99 6.09V16h9.91zM6.55 4l12 12H21V4z"),
        },
    ];
