...
public class ActionExtensionOffRounded : MaterialIcon
{
    public ActionExtensionOffRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.71, 1.5, 20.789999999999999, 20.789999999999999);
