...
public class ActionNetworkPingRounded : MaterialIcon
{
    public ActionNetworkPingRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.3199999999999998, 6, 19.68, 12);
