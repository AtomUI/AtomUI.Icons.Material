...
public class DeviceMediaBluetoothOffRounded : MaterialIcon
{
    public DeviceMediaBluetoothOffRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.71, 3, 20.130000000000003, 19.289999999999999);
