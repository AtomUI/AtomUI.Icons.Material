...
public class MapsPestControlRodentTwoTone : MaterialIcon
{
    public MapsPestControlRodentTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 3, 21.23, 18);
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M17.65,14.75C17.87,14.38,18,13.96,18,13.5c0-1.38-1.12-2.5-2.5-2.5c-1.3,0-2.5,1.08-2.5,2.5 c0,0.69,0.28,1.32,0.73,1.77l-1.41,1.41C11.5,15.87,11,14.74,11,13.5c0-0.92,0.28-1.76,0.75-2.47c-0.22,0.01-0.44,0.02-0.67,0.07 c-1.48,0.32-2.68,1.53-2.99,3.01c-0.26,1.24,0.02,2.45,0.8,3.41C9.66,18.46,10.79,19,12,19h6.53c0.81,0,1.47-0.66,1.47-1.47 c0-0.41-0.17-0.81-0.48-1.09L17.65,14.75z M17,18c-0.55,0-1-0.45-1-1c0-0.55,0.45-1,1-1s1,0.45,1,1C18,17.55,17.55,18,17,18z"),
        },
        new CircleDrawingInstruction()
        {
            Opacity = 1,
            FillBrush = IconBrushType.Stroke,
            Center = new Avalonia.Point(17, 17),
            Radius = 1
        },
        new PathDrawingInstruction()
        {
