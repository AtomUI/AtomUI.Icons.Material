...
public class MapsHandymanRounded : MaterialIcon
{
    public MapsHandymanRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.8999999999999999, 1.05, 20.16, 21.050000000000001);
