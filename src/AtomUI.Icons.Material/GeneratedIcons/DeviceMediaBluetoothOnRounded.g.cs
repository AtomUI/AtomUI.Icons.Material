...
public class DeviceMediaBluetoothOnRounded : MaterialIcon
{
    public DeviceMediaBluetoothOnRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3, 3, 17.680000000000003, 18.060000000000006);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.1461318051575935, 0, 0, 1.1461318051575935, -1.753581661891122, -1.753581661891122);
