...
public class PlacesDryTwoTone : MaterialIcon
{
    public PlacesDryTwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M10,21H4c-0.55,0-1-0.45-1-1v-6c0-0.39,0.23-0.64,0.36-0.75L7,9.87V12l3,0V21z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
