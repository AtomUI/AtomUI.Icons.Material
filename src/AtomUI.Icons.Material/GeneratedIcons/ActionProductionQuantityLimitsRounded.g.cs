...
public class ActionProductionQuantityLimitsRounded : MaterialIcon
{
    public ActionProductionQuantityLimitsRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 1, 19.789999999999999, 21);
