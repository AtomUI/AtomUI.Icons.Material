...
public class ImageImageSearchRounded : MaterialIcon
{
    public ImageImageSearchRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 1.73, 20.100000000000001, 20.27);
