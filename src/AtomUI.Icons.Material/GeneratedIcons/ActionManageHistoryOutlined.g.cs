...
public class ActionManageHistoryOutlined : MaterialIcon
{
    public ActionManageHistoryOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3, 3, 20.830000000000002, 21);
