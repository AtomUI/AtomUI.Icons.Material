...
public class ActionTerminalTwoTone : Icon
{
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        ...
        new PolygonDrawingInstruction()
        {
            Opacity = 1,
            FillBrush = IconBrushType.Stroke,
            Points = [new Point(7.5, 17),new Point(11.5, 13),new Point(7.5, 9),new Point(6.09, 10.41),new Point(8.67, 13),new Point(6.09, 15.59)]
        },
    ];
