...
public class HardwareKeyboardArrowLeftOutlined : MaterialIcon
{
    public HardwareKeyboardArrowLeftOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(8, 6, 7.4100000000000001, 12);
