...
public class PlacesNoStrollerRounded : MaterialIcon
{
    public PlacesNoStrollerRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.7099999999999995, 3, 20.25, 19.289999999999999);
