...
public class NavigationAppSettingsAltRounded : MaterialIcon
{
    public NavigationAppSettingsAltRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(5, 1, 16.900000000000002, 22);
