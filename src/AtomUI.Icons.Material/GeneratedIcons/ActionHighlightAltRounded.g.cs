...
public class ActionHighlightAltRounded : MaterialIcon
{
    public ActionHighlightAltRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3, 3, 18.09, 18.09);
