...
public class SocialNordicWalkingOutlined : MaterialIcon
{
    public SocialNordicWalkingOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 1.5, 15, 21.5);
