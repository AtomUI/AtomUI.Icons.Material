...
public class CommunicationAlternateEmailTwoTone : MaterialIcon
{
    public CommunicationAlternateEmailTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 1.9499999999999993, 20, 20);
