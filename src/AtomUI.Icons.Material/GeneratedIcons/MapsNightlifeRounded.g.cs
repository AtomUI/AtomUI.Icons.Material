...
public class MapsNightlifeRounded : MaterialIcon
{
    public MapsNightlifeRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.5900000000000001, 5, 20.41, 15.280000000000001);
