...
public class DeviceNetworkWifi1BarTwoTone : MaterialIcon
{
    public DeviceNetworkWifi1BarTwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M15.32,14.84C14.34,14.3,13.2,14,12,14c-1.2,0-2.34,0.3-3.32,0.84L2.92,9.07C5.51,7.08,8.67,6,12,6 s6.49,1.08,9.08,3.07L15.32,14.84z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
