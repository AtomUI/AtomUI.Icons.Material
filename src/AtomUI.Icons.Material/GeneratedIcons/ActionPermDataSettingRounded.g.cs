...
public class ActionPermDataSettingRounded : MaterialIcon
{
    public ActionPermDataSettingRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.0800000000000001, 1.0799999999999998, 22.809999999999995, 22.920000000000002);
