...
public class ActionRowingRounded : MaterialIcon
{
    public ActionRowingRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4.3399999999999999, 1, 16.34, 22.68);
