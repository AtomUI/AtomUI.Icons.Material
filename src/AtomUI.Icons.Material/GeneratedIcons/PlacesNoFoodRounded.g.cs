...
public class PlacesNoFoodRounded : MaterialIcon
{
    public PlacesNoFoodRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(0.98999999999999999, 1, 21.960000000000001, 22);
