...
public class ActionSensorsOffOutlined : MaterialIcon
{
    public ActionSensorsOffOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.3899999999999999, 2.8099999999999996, 20.609999999999999, 19.789999999999999);
