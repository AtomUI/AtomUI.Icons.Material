...
public class NotificationNetworkLockedRounded : MaterialIcon
{
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3.0800000000000001, 3.0800000000000001, 19.920000000000002, 18.920000000000002);
