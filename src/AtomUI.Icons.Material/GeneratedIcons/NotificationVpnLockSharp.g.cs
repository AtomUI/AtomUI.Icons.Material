...
public class NotificationVpnLockSharp : MaterialIcon
{
    public NotificationVpnLockSharp()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 0.85999999999999999, 22, 22.140000000000001);
