...
public class PlacesAllInclusiveRounded : MaterialIcon
{
    public PlacesAllInclusiveRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(0, 6.2600000000000007, 24.449999999999999, 11.119999999999997);
    internal override Matrix GeneratedZoomMatrix => new Matrix(0.94674556213017758, 0, 0, 0.94674556213017758, 0.63905325443786865, 0.63905325443786865);
