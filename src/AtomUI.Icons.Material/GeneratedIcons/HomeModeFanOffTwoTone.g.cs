...
public class HomeModeFanOffTwoTone : MaterialIcon
{
    public HomeModeFanOffTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.3899999999999999, 2, 20.609999999999999, 20.600000000000001);
