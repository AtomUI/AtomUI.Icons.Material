...
public class ActionSettingsBackupRestoreRounded : MaterialIcon
{
    public ActionSettingsBackupRestoreRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3, 2.8799999999999999, 18.140000000000001, 18.120000000000001);
