...
public class ActionGeneratingTokensRounded : MaterialIcon
{
    public ActionGeneratingTokensRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 1.6099999999999999, 21.390000000000001, 20.780000000000001);
