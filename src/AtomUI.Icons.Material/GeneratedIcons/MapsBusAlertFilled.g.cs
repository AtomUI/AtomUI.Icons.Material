...
public class MapsBusAlertFilled : MaterialIcon
{
    public MapsBusAlertFilled()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 1, 16, 22);
