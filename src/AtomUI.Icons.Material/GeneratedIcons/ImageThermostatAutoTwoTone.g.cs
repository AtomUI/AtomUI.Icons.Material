...
public class ImageThermostatAutoTwoTone : MaterialIcon
{
    public ImageThermostatAutoTwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M9.8,13.6L9,13V6c0-0.55-0.45-1-1-1S7,5.45,7,6v7l-0.8,0.6C5.45,14.16,5,15.06,5,16h6 C11,15.06,10.55,14.17,9.8,13.6z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
