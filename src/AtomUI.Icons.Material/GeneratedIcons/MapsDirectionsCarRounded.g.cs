...
public class MapsDirectionsCarRounded : MaterialIcon
{
    public MapsDirectionsCarRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3.0000000000000004, 5, 18, 16);
