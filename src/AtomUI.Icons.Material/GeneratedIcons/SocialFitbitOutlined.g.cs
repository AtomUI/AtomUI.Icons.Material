...
public class SocialFitbitOutlined : MaterialIcon
{
    public SocialFitbitOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.2400000000000002, 2, 19.539999999999999, 20);
