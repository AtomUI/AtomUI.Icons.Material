...
public class ActionRemoveDoneRounded : MaterialIcon
{
    public ActionRemoveDoneRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.3999999999999999, 2.2999999999999998, 21.510000000000002, 19.16);
