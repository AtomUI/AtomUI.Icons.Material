...
public class PlacesSmokingRoomsRounded : MaterialIcon
{
    public PlacesSmokingRoomsRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 2.0000000000000004, 20.000000000000004, 17);
