...
public class ActionPublishedWithChangesRounded : MaterialIcon
{
    public ActionPublishedWithChangesRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 2.1099999999999999, 20, 19.780000000000001);
