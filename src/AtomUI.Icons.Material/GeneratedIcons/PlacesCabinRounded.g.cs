...
public class PlacesCabinRounded : MaterialIcon
{
    public PlacesCabinRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.2799999999999998, 1, 21.449999999999999, 20);
