...
public class SocialFrontHandTwoTone : MaterialIcon
{
    public SocialFrontHandTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 0, 17, 24);
