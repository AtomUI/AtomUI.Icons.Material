...
public class DeviceUsbOffRounded : MaterialIcon
{
    public DeviceUsbOffRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.71, 2.2600000000000002, 19.169999999999998, 20.029999999999998);
