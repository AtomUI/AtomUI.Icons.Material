...
public class SocialTransgenderOutlined : MaterialIcon
{
    public SocialTransgenderOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.5, 1, 21, 22);
