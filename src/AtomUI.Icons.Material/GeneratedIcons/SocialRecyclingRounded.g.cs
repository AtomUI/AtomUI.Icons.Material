...
public class SocialRecyclingRounded : MaterialIcon
{
    public SocialRecyclingRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.6500000000000008, 2, 20.349999999999998, 20.460000000000001);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.0791366906474822, 0, 0, 1.0791366906474822, -0.94964028776978537, -0.94964028776978537);
