...
public class PlacesStorefrontTwoTone : MaterialIcon
{
    public PlacesStorefrontTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.8600000000000001, 3, 20.289999999999999, 18);
