...
public class SocialFace4TwoTone : MaterialIcon
{
    public SocialFace4TwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(0, 0, 22, 22);
