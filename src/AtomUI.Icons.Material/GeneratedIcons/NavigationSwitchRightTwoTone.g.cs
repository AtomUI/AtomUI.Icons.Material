...
public class NavigationSwitchRightTwoTone : MaterialIcon
{
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PolylineDrawingInstruction()
        {
            ...
            Points = [new Avalonia.Point(15.5, 15.38),new Avalonia.Point(15.5, 8.62),new Avalonia.Point(18.88, 12),new Avalonia.Point(15.5, 15.38)]
        },
