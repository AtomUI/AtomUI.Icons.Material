...
public class PlacesFamilyRestroomRounded : MaterialIcon
{
    public PlacesFamilyRestroomRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 2, 20.27, 20);
