...
public class ActionManageAccountsRounded : MaterialIcon
{
    public ActionManageAccountsRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 4, 19.75, 16.989999999999995);
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M10.67,13.02C10.45,13.01,10.23,13,10,13c-2.42,0-4.68,0.67-6.61,1.82C2.51,15.34,2,16.32,2,17.35V19c0,0.55,0.45,1,1,1 h8.26C10.47,18.87,10,17.49,10,16C10,14.93,10.25,13.93,10.67,13.02z"),
        },
