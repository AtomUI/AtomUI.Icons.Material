...
public class SocialMilitaryTechRounded : MaterialIcon
{
    public SocialMilitaryTechRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(7, 2, 10, 19.620000000000001);
