...
public class PlacesSpaRounded : MaterialIcon
{
    public PlacesSpaRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 2.370000000000001, 20.02, 19.640000000000001);
