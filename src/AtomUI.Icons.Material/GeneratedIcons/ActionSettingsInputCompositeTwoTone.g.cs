...
public class ActionSettingsInputCompositeTwoTone : MaterialIcon
{
    public ActionSettingsInputCompositeTwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M3 16c0 .55.45 1 1 1s1-.45 1-1v-2H3v2zm8 0c0 .55.45 1 1 1s1-.45 1-1v-2h-2v2zm8 0c0 .55.45 1 1 1s1-.45 1-1v-2h-2v2z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
