...
public class PlacesGrassRounded : MaterialIcon
{
    public PlacesGrassRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 4.6799999999999997, 20, 15.32);
