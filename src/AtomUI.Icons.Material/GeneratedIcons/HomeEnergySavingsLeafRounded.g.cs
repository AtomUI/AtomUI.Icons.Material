...
public class HomeEnergySavingsLeafRounded : MaterialIcon
{
    public HomeEnergySavingsLeafRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.8999999999999999, 3, 18.100000000000001, 18.09);
