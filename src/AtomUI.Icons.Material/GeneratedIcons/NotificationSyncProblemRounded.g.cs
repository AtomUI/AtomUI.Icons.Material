...
public class NotificationSyncProblemRounded : MaterialIcon
{
    public NotificationSyncProblemRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3, 4, 18, 16.000000000000004);
