...
public class SocialDownhillSkiingRounded : MaterialIcon
{
    public SocialDownhillSkiingRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.1100000000000003, 2.5, 19.510000000000002, 20.5);
