...
public class PlacesBeachAccessOutlined : MaterialIcon
{
    public PlacesBeachAccessOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.0199999999999996, 3, 18.98, 17.998000000000001);
