...
public class MapsCarRentalRounded : MaterialIcon
{
    public MapsCarRentalRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4.7000000000000002, 0.76000000000000001, 14.300000000000001, 21.239999999999998);
