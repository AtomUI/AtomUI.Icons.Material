...
public class SocialEngineeringTwoTone : MaterialIcon
{
    public SocialEngineeringTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 3, 21.91, 18);
