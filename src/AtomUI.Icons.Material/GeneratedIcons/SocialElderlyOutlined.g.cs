...
public class SocialElderlyOutlined : MaterialIcon
{
    public SocialElderlyOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(6, 1.5, 14, 21.5);
