...
public class Image11mpOutlined : Icon
{
    public Image11mpOutlined()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        ...
        new PolygonDrawingInstruction()
        {
            Opacity = 1,
            FillBrush = IconBrushType.Stroke,
            Points = [new Point(9.5, 11.5),new Point(11, 11.5),new Point(11, 5.5),new Point(8, 5.5),new Point(8, 7),new Point(9.5, 7)]
        },
        new PolygonDrawingInstruction()
        {
            Opacity = 1,
