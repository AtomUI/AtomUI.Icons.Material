...
public class DeviceWifiTetheringErrorRoundedOutlined : MaterialIcon
{
    public DeviceWifiTetheringErrorRoundedOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 3, 20, 17.07);
