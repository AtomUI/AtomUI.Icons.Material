...
public class PlacesNoBackpackTwoTone : MaterialIcon
{
    public PlacesNoBackpackTwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M18,15.17V8c0-1.1-0.9-2-2-2H8.83l6,6h1.67v1.67L18,15.17z M17.17,20l-6-6H7.5v-2h1.67L6,8.83V20H17.17z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
