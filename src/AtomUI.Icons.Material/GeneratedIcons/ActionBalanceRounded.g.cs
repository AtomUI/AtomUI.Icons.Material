...
public class ActionBalanceRounded : MaterialIcon
{
    public ActionBalanceRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.9900000000000002, 2, 20.020000000000003, 19);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.090413448432531, 0, 0, 1.090413448432531, -1.0849613811903716, -1.0849613811903716);
