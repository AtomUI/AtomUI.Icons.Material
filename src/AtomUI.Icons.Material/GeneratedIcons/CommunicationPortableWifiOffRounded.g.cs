...
public class CommunicationPortableWifiOffRounded : MaterialIcon
{
    public CommunicationPortableWifiOffRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 2, 20, 19.18);
