...
public class ImageDeblurOutlined : MaterialIcon
{
    public ImageDeblurOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.5, 2.5, 18.5, 19);
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        ...
        new CircleDrawingInstruction()
        {
            Opacity = 1,
            FillBrush = IconBrushType.Stroke,
            Center = new Avalonia.Point(3, 10),
            Radius = 0.5
        },
        new CircleDrawingInstruction()
        {
        ...
        new CircleDrawingInstruction()
        {
            Opacity = 1,
            FillBrush = IconBrushType.Stroke,
            Center = new Avalonia.Point(3, 14),
            Radius = 0.5
        },
        new CircleDrawingInstruction()
        {
            Opacity = 1,
            FillBrush = IconBrushType.Stroke,
            Center = new Avalonia.Point(10, 21),
            Radius = 0.5
        },
        new CircleDrawingInstruction()
        {
            Opacity = 1,
            FillBrush = IconBrushType.Stroke,
            Center = new Avalonia.Point(10, 3),
            Radius = 0.5
        },
        new CircleDrawingInstruction()
        {
        ...
        new PathDrawingInstruction()
        {
            Opacity = 1,
            FillBrush = IconBrushType.Stroke,
            Data = StreamGeometry.Parse("M12,3v2c3.86,0,7,3.14,7,7s-3.14,7-7,7v2c4.96,0,9-4.04,9-9S16.96,3,12,3z"),
        },
    ];
