...
public class MapsLunchDiningFilled : MaterialIcon
{
    public MapsLunchDiningFilled()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.7, 4, 20.620000000000001, 16);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.0771992818671454, 0, 0, 1.0771992818671454, -0.92639138240574503, -0.92639138240574503);
