...
public class MapsEmergencyRounded : MaterialIcon
{
    public MapsEmergencyRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3.4300000000000002, 3, 17.150000000000002, 18);
