...
public class MapsAddLocationAltRounded : MaterialIcon
{
    public MapsAddLocationAltRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 0, 19, 21.759999999999998);
