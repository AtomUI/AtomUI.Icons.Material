...
public class HomeElectricMeterRounded : MaterialIcon
{
    public HomeElectricMeterRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.8700000000000001, 1.8500000000000001, 18.129999999999999, 20.149999999999999);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.0835214446952595, 0, 0, 1.0835214446952595, -1.0022573363431135, -1.0022573363431135);
