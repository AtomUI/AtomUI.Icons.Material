...
public class ActionSwipeLeftRounded : MaterialIcon
{
    public ActionSwipeLeftRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 1, 19.84, 22);
