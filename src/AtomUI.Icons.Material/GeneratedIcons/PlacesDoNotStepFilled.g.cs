...
public class PlacesDoNotStepFilled : MaterialIcon
{
    public PlacesDoNotStepFilled()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 2, 22, 20.610000000000003);
