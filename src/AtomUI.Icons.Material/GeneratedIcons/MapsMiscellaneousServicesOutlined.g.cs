...
public class MapsMiscellaneousServicesOutlined : MaterialIcon
{
    public MapsMiscellaneousServicesOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.96, 2, 20.07, 19.960000000000001);
