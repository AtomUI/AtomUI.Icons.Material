...
public class MapsPestControlRounded : MaterialIcon
{
    public MapsPestControlRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3, 3.0699999999999998, 18, 17.93);
