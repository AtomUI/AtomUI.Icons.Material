...
public class NotificationPhoneLockedRounded : MaterialIcon
{
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M20,5V4.11c0-1-0.68-1.92-1.66-2.08C17.08,1.82,16,2.79,16,4v1c-0.55,0-1,0.45-1,1v3c0,0.55,0.45,1,1,1h4 c0.55,0,1-0.45,1-1V6C21,5.45,20.55,5,20,5z M19,5h-2V4c0-0.55,0.45-1,1-1s1,0.45,1,1V5z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
