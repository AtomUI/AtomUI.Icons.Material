...
public class ActionSensorsRounded : MaterialIcon
{
    public ActionSensorsRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 5.2599999999999998, 20, 13.480000000000002);
