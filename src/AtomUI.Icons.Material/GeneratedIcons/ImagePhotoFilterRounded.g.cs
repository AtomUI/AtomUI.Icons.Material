...
public class ImagePhotoFilterRounded : MaterialIcon
{
    public ImagePhotoFilterRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3.0199999999999996, 3, 17.98, 18);
