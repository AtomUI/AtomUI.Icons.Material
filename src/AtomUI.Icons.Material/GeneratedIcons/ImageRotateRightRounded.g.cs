...
public class ImageRotateRightRounded : MaterialIcon
{
    public ImageRotateRightRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 2.0800000000000001, 15.859999999999999, 17.780000000000001);
