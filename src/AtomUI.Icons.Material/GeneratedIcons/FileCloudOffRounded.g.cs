...
public class FileCloudOffRounded : MaterialIcon
{
    public FileCloudOffRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(-0.41000000000000014, 4, 24.41, 17.68);
    internal override Matrix GeneratedZoomMatrix => new Matrix(0.98320360507988525, 0, 0, 0.98320360507988525, 0.2015567390413775, 0.2015567390413775);
