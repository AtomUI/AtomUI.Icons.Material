...
public class ActionPowerSettingsNewRounded : MaterialIcon
{
    public ActionPowerSettingsNewRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.8599999999999999, 3, 18.140000000000001, 18.150000000000002);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.1358258400378609, 0, 0, 1.1358258400378609, -1.6299100804543301, -1.6299100804543301);
