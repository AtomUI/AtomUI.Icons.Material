...
public class ImageExposureZeroTwoTone : MaterialIcon
{
    public ImageExposureZeroTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(7.8600000000000003, 5, 8.2900000000000027, 13);
