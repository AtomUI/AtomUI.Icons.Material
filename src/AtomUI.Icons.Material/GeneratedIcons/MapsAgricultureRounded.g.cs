...
public class MapsAgricultureRounded : MaterialIcon
{
    public MapsAgricultureRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 2.9399999999999999, 22, 17.030000000000001);
