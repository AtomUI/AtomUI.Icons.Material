...
public class ActionProductionQuantityLimitsOutlined : MaterialIcon
{
    public ActionProductionQuantityLimitsOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 1, 20, 21);
