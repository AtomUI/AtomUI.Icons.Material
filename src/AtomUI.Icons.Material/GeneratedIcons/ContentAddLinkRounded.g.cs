...
public class ContentAddLinkRounded : MaterialIcon
{
    public ContentAddLinkRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.74, 7, 20.260000000000002, 13);
