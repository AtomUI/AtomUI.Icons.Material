...
public class HardwareVideogameAssetOffRounded : MaterialIcon
{
    public HardwareVideogameAssetOffRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.7099999999999995, 3.1199999999999997, 20.289999999999999, 19.169999999999998);
