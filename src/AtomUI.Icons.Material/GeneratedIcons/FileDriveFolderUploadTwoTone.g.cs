...
public class FileDriveFolderUploadTwoTone : MaterialIcon
{
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        ...
        new PolygonDrawingInstruction()
        {
            Opacity = 1,
            FillBrush = IconBrushType.Stroke,
            Points = [new Avalonia.Point(11, 13),new Avalonia.Point(11, 17),new Avalonia.Point(13, 17),new Avalonia.Point(13, 13),new Avalonia.Point(16, 13),new Avalonia.Point(12.01, 9),new Avalonia.Point(8, 13)]
        },
    ];
