...
public class MapsMultipleStopRounded : MaterialIcon
{
    public MapsMultipleStopRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3.1600000000000001, 4.54, 17.68, 14.920000000000002);
