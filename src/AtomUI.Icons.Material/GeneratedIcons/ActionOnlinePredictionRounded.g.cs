...
public class ActionOnlinePredictionRounded : MaterialIcon
{
    public ActionOnlinePredictionRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 5.1699999999999999, 20, 13.83);
