...
public class SocialKayakingRounded : MaterialIcon
{
    public SocialKayakingRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.609999999999999, 2.180000000000001, 20.789999999999999, 21.09);
