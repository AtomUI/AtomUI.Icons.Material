...
public class SocialTsunamiRounded : MaterialIcon
{
    public SocialTsunamiRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.9699999999999998, 3, 20.040000000000003, 18.280000000000001);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.0894235133908305, 0, 0, 1.0894235133908305, -1.0730821606899674, -1.0730821606899674);
