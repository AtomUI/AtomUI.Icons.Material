...
public class ImageColorizeRounded : MaterialIcon
{
    public ImageColorizeRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3.0000000000000004, 2.8999999999999999, 18.100000000000001, 18.100000000000001);
