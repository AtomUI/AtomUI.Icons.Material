...
public class ImageWbIncandescentRounded : MaterialIcon
{
    public ImageWbIncandescentRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 2.0499999999999998, 21.989999999999998, 20.949999999999999);
