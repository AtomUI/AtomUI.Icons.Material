...
public class PlacesHotTubRounded : MaterialIcon
{
    public PlacesHotTubRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 2.9999999999999991, 20, 19);
