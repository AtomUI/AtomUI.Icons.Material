...
public class ImageRawOffRounded : MaterialIcon
{
    public ImageRawOffRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.7099999999999995, 3.1199999999999997, 19.66, 19.169999999999998);
