...
public class MapsAttractionsOutlined : MaterialIcon
{
    public MapsAttractionsOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.8299999999999996, 2, 18.340000000000003, 20);
