...
public class ActionTrackChangesRounded : MaterialIcon
{
    public ActionTrackChangesRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.6599999999999997, 1.8, 20.830000000000002, 21.419999999999998);
