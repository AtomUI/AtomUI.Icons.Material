...
public class ActionPanToolOutlined : MaterialIcon
{
    public ActionPanToolOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.2599999999999989, 0.0099999999999997868, 20.740000000000002, 23.990000000000002);
