...
public class ActionTaskAltRounded : MaterialIcon
{
    public ActionTaskAltRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.01, 1.8100000000000001, 21.09, 20.970000000000002);
