...
public class Av10kTwoTone : Icon
{
    public Av10kTwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        ...
        new PolygonDrawingInstruction()
        {
            Opacity = 0.3,
            FillBrush = IconBrushType.Fill,
            Points = [new Point(19, 15),new Point(19, 9),new Point(16.75, 12)]
        },
        ...
        new PolygonDrawingInstruction()
        {
            Opacity = 1,
            FillBrush = IconBrushType.Stroke,
            Points = [new Point(15.5, 11.25),new Point(15.5, 9),new Point(14, 9),new Point(14, 15),new Point(15.5, 15),new Point(15.5, 12.75),new Point(17.25, 15),new Point(19, 15),new Point(16.75, 12),new Point(19, 9),new Point(17.25, 9)]
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
