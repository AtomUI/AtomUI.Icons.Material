...
public class ContentLinkOffRounded : MaterialIcon
{
    public ContentLinkOffRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.7099999999999995, 3.1199999999999997, 20.500000000000004, 19.169999999999998);
