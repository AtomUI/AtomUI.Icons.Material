...
public class MapsEmergencyShareRounded : MaterialIcon
{
    public MapsEmergencyShareRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4.5499999999999998, 0, 14.91, 23.75);
