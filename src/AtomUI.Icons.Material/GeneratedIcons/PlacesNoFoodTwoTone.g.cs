...
public class PlacesNoFoodTwoTone : MaterialIcon
{
    public PlacesNoFoodTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(0.67999999999999972, 1, 22.32, 22.309999999999999);
