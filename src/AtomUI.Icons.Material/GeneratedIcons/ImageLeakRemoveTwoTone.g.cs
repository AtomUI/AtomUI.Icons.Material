...
public class ImageLeakRemoveTwoTone : MaterialIcon
{
    public ImageLeakRemoveTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3, 2.8599999999999999, 18.140000000000001, 18.140000000000001);
