...
public class EditorChecklistRtlRounded : MaterialIcon
{
    public EditorChecklistRtlRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 4.2399999999999984, 19.68, 14.440000000000001);
