...
public class EditorChecklistRounded : MaterialIcon
{
    public EditorChecklistRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.3100000000000001, 4.25, 19.690000000000001, 14.440000000000001);
