...
public class ActionCurrencyExchangeRounded : MaterialIcon
{
    public ActionCurrencyExchangeRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 1, 22.009999999999998, 22);
