...
public class SocialEmojiNatureFilled : MaterialIcon
{
    public SocialEmojiNatureFilled()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.8999999999999999, 2, 20.220000000000002, 20);
