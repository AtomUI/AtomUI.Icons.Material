...
public class AvNewReleasesRounded : MaterialIcon
{
    public AvNewReleasesRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.2499999999999993, 1.6699999999999982, 21.499999999999996, 20.66);
