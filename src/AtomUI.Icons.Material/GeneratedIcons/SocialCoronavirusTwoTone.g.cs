...
public class SocialCoronavirusTwoTone : MaterialIcon
{
    public SocialCoronavirusTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 2, 20, 20.009999999999994);
