...
public class SocialCompostOutlined : MaterialIcon
{
    public SocialCompostOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.5, 0, 19, 21.5);
