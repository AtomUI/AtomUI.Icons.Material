...
public class NotificationSyncLockOutlined : MaterialIcon
{
    public NotificationSyncLockOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 4, 17, 18);
