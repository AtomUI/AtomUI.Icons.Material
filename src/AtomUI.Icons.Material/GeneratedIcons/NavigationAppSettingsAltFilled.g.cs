...
public class NavigationAppSettingsAltFilled : MaterialIcon
{
    public NavigationAppSettingsAltFilled()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(5, 1, 17.009999999999998, 22);
