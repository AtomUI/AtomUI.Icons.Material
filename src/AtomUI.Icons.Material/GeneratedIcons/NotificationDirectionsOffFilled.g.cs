...
public class NotificationDirectionsOffFilled : MaterialIcon
{
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.3899999999999999, 1.8, 20.809999999999999, 20.809999999999999);
