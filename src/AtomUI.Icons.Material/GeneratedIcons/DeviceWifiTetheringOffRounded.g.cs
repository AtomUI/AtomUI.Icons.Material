...
public class DeviceWifiTetheringOffRounded : MaterialIcon
{
    public DeviceWifiTetheringOffRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.71, 3, 20.289999999999999, 19.280000000000001);
