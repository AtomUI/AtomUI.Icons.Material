...
public class PlacesDryRounded : MaterialIcon
{
    public PlacesDryRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 2, 21.079999999999998, 21);
