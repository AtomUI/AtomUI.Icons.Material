...
public class SocialPsychologyAltTwoTone : MaterialIcon
{
    public SocialPsychologyAltTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3.7400000000000002, 3, 16.609999999999999, 18);
