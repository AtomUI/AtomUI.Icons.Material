...
public class ActionThumbsUpDownRounded : MaterialIcon
{
    public ActionThumbsUpDownRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(0, 0.35999999999999999, 24, 23.280000000000001);
