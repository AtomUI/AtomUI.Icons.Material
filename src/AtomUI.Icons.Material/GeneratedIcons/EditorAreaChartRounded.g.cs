...
public class EditorAreaChartRounded : MaterialIcon
{
    public EditorAreaChartRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3, 3.3000000000000003, 18, 16.699999999999999);
