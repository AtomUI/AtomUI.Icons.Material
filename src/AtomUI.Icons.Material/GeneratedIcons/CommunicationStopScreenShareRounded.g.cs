...
public class CommunicationStopScreenShareRounded : MaterialIcon
{
    public CommunicationStopScreenShareRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(0, 1.8899999999999997, 24, 20.5);
