...
public class SocialWaterDropRounded : MaterialIcon
{
    public SocialWaterDropRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 2.25, 16, 19.75);
