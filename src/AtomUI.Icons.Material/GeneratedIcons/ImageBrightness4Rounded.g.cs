...
public class ImageBrightness4Rounded : MaterialIcon
{
    public ImageBrightness4Rounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.0099999999999998, 1.0099999999999998, 21.979999999999997, 21.980000000000004);
