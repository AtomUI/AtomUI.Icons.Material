...
public class AvForward5Rounded : MaterialIcon
{
    public AvForward5Rounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3.1100000000000012, 1.54, 16.850000000000001, 20.329999999999998);
