...
public class ActionSettingsVoiceRounded : MaterialIcon
{
    public ActionSettingsVoiceRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4.9900000000000002, 1, 14.01, 23);
