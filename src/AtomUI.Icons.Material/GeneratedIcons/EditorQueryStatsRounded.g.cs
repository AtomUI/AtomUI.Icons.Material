...
public class EditorQueryStatsRounded : MaterialIcon
{
    public EditorQueryStatsRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.2200000000000006, 2.29, 21.549999999999997, 20.390000000000001);
