...
public class ImagePanoramaHorizontalSelectTwoTone : MaterialIcon
{
    public ImagePanoramaHorizontalSelectTwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M4,6.38v11.25c2.01-0.59,4.61-1.13,8-1.13c3.38,0,5.99,0.54,8,1.13V6.37 c-2.01,0.59-4.62,1.13-8,1.13C9.32,7.5,6.58,7.11,4,6.38z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
