...
public class MapsPedalBikeOutlined : MaterialIcon
{
    public MapsPedalBikeOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(0, 4, 24, 16.120000000000001);
