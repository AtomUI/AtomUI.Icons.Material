...
public class Image10mpTwoTone : MaterialIcon
{
    public Image10mpTwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        ...
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M13,11.5h2.5c0.55,0,1-0.45,1-1v-4c0-0.55-0.45-1-1-1H13c-0.55,0-1,0.45-1,1v4C12,11.05,12.45,11.5,13,11.5z M13.5,7H15 v3h-1.5V7z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
