...
public class NavigationAppSettingsAltOutlined : MaterialIcon
{
    public NavigationAppSettingsAltOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(5, 1, 17.010000000000002, 22);
