...
public class MapsAttractionsSharp : MaterialIcon
{
    public MapsAttractionsSharp()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.8399999999999999, 2, 18.330000000000005, 20);
