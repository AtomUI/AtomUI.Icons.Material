...
public class CommunicationPhonelinkSetupOutlined : MaterialIcon
{
    public CommunicationPhonelinkSetupOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3.129999999999999, 1, 17.870000000000001, 22);
