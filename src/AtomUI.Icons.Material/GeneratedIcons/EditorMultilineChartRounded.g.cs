...
public class EditorMultilineChartRounded : MaterialIcon
{
    public EditorMultilineChartRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.3100000000000005, 5, 19.43, 13.190000000000001);
