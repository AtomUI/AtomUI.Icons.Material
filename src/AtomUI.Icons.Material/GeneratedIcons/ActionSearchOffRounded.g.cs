...
public class ActionSearchOffRounded : MaterialIcon
{
    public ActionSearchOffRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(0.96999999999999997, 2.5800000000000001, 19.18, 17.579999999999998);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.0421189752496745, 0, 0, 1.0421189752496745, -0.5054277029960943, -0.5054277029960943);
