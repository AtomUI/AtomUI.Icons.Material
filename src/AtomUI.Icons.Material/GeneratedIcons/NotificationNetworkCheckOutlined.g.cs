...
public class NotificationNetworkCheckOutlined : MaterialIcon
{
    public NotificationNetworkCheckOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 3.8399999999999999, 22, 16.16);
