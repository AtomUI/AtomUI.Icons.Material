...
public class MapsLocalDrinkRounded : MaterialIcon
{
    public MapsLocalDrinkRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3.1099999999999999, 1.9999999999999987, 17.779999999999998, 20);
