...
public class MapsBakeryDiningTwoTone : MaterialIcon
{
    public MapsBakeryDiningTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 5, 22.009999999999998, 14.479999999999997);
