...
public class NavigationChevronRightFilled : MaterialIcon
{
    public NavigationChevronRightFilled()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"),
        },
    ];
