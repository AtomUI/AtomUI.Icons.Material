...
public class NavigationAppsOutageOutlined : MaterialIcon
{
    public NavigationAppsOutageOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 0, 20, 20);
