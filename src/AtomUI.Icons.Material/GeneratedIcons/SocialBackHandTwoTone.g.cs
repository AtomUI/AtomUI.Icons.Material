...
public class SocialBackHandTwoTone : MaterialIcon
{
    public SocialBackHandTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.4199999999999999, 0, 18.579999999999998, 24);
