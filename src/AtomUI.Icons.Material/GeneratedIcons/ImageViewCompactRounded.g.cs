...
public class ImageViewCompactRounded : MaterialIcon
{
    public ImageViewCompactRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 6, 16, 12);
