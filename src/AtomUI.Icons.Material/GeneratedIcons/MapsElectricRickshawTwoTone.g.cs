...
public class MapsElectricRickshawTwoTone : MaterialIcon
{
    public MapsElectricRickshawTwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M3,13h0.17C3.58,11.84,4.7,11,6,11c0.35,0,0.69,0.06,1,0.17V10H3V13z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 0.3,
            FillBrush = IconBrushType.Fill,
            Data = StreamGeometry.Parse("M19,11h-3v2h1.17c0.3-0.85,0.98-1.53,1.83-1.83V11z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
