...
public class ActionSettingsPowerRounded : MaterialIcon
{
    public ActionSettingsPowerRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3.5800000000000001, 2, 16.420000000000002, 22);
