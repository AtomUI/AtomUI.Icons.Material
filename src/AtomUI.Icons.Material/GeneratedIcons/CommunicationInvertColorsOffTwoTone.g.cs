...
public class CommunicationInvertColorsOffTwoTone : MaterialIcon
{
    public CommunicationInvertColorsOffTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.3899999999999999, 2, 19.800000000000001, 20.600000000000001);
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M12,14.83L12,19c-3.31,0-6-2.63-6-5.87c0-1.19,0.36-2.32,1.02-3.28L12,14.83z M12,4.81l0,4.37l-2.2-2.2 L12,4.81"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
