...
public class ActionDisabledVisibleTwoTone : MaterialIcon
{
    public ActionDisabledVisibleTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 2, 22, 20);
