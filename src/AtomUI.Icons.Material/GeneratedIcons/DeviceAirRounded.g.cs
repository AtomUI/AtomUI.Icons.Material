...
public class DeviceAirRounded : MaterialIcon
{
    public DeviceAirRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 2.6899999999999999, 20.280000000000001, 17.639999999999997);
