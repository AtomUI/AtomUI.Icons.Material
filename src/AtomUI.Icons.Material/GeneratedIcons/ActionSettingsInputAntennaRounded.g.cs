...
public class ActionSettingsInputAntennaRounded : MaterialIcon
{
    public ActionSettingsInputAntennaRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 1, 22.009999999999998, 21.09);
