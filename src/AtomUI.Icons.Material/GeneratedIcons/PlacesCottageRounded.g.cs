...
public class PlacesCottageRounded : MaterialIcon
{
    public PlacesCottageRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.27, 1, 21.460000000000001, 20);
