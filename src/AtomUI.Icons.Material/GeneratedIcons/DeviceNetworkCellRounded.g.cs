...
public class DeviceNetworkCellRounded : MaterialIcon
{
    public DeviceNetworkCellRounded()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M4.41,22H21c0.55,0,1-0.45,1-1V4.41c0-0.89-1.08-1.34-1.71-0.71L3.71,20.29C3.08,20.92,3.52,22,4.41,22z M20,20h-3V9.83 l3-3V20z"),
        },
    ];
