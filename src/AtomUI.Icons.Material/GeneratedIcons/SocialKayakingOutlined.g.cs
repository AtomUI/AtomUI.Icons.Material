...
public class SocialKayakingOutlined : MaterialIcon
{
    public SocialKayakingOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(0, 2, 24, 21.25);
