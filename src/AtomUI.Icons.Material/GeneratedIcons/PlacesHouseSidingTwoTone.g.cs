...
public class PlacesHouseSidingTwoTone : MaterialIcon
{
    public PlacesHouseSidingTwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M7.21,10h9.58L17,10.19V12H7v-1.81L7.21,10z M14.57,8H9.43L12,5.69L14.57,8z M7,16v-2h10v2H7z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
