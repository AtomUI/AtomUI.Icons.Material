...
public class DeviceSsidChartRounded : MaterialIcon
{
    public DeviceSsidChartRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3, 3.6699999999999999, 18, 17.100000000000001);
