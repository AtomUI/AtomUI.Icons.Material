...
public class ActionEditOffTwoTone : MaterialIcon
{
    public ActionEditOffTwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M5,18.08V19h0.92l5.12-5.12l-0.92-0.92L5,18.08z M14.06,9.02l-1.11,1.11l0.92,0.92l1.11-1.11L14.06,9.02z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
