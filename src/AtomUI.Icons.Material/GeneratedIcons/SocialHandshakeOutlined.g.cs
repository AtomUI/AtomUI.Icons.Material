...
public class SocialHandshakeOutlined : MaterialIcon
{
    public SocialHandshakeOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(0.61999999999999988, 1.6099999999999999, 22.769999999999996, 20.379999999999992);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.0269576379974323, 0, 0, 1.0269576379974323, -0.32349165596918894, -0.32349165596918894);
