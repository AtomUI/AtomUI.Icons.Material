...
public class ActionSwipeUpTwoTone : MaterialIcon
{
    public ActionSwipeUpTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 1, 22.670000000000005, 21.050000000000001);
