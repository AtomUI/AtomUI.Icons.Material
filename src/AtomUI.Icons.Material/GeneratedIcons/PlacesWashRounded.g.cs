...
public class PlacesWashRounded : MaterialIcon
{
    public PlacesWashRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 1.21, 21.079999999999998, 21.789999999999999);
