...
public class ActionRuleRounded : MaterialIcon
{
    public ActionRuleRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 4.2399999999999984, 19.870000000000001, 15.440000000000001);
