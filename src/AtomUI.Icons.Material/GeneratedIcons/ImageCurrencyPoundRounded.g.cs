...
public class ImageCurrencyPoundRounded : MaterialIcon
{
    public ImageCurrencyPoundRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(6, 2.5, 11.91, 18.5);
