...
public class CommunicationRingVolumeRounded : MaterialIcon
{
    public CommunicationRingVolumeRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(-0.040000000000001257, 2, 24.18, 19.109999999999999);
    internal override Matrix GeneratedZoomMatrix => new Matrix(0.98280098280098316, 0, 0, 0.98280098280098316, 0.20638820638820121, 0.20638820638820121);
