...
public class SocialConstructionRounded : MaterialIcon
{
    public SocialConstructionRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.4699999999999998, 2.3199999999999994, 19.100000000000001, 18.379999999999999);
