...
public class CommunicationSwapCallsRounded : MaterialIcon
{
    public CommunicationSwapCallsRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.54, 3.79, 18.920000000000002, 15.420000000000002);
