...
public class ImageFilterTiltShiftRounded : MaterialIcon
{
    public ImageFilterTiltShiftRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.1000000000000001, 2.1000000000000001, 19.799999999999997, 19.799999999999997);
