...
public class AvInterpreterModeTwoTone : MaterialIcon
{
    public AvInterpreterModeTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 4, 23, 16);
