...
public class SocialSnowshoeingOutlined : MaterialIcon
{
    public SocialSnowshoeingOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 1.5, 16, 21.550000000000001);
