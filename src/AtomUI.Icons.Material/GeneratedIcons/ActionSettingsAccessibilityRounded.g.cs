...
public class ActionSettingsAccessibilityRounded : MaterialIcon
{
    public ActionSettingsAccessibilityRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3.1099999999999999, 0, 17.780000000000001, 24);
