...
public class SocialDiversity2TwoTone : Icon
{
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M2.5,17.97c-0.48,0.28-0.64,0.89-0.37,1.37s0.89,0.64,1.37,0.37c0.48-0.28,0.64-0.89,0.37-1.37 S2.98,17.69,2.5,17.97z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 0.3,
            FillBrush = IconBrushType.Fill,
            Data = StreamGeometry.Parse("M21.5,17.97c-0.48-0.28-1.09-0.11-1.37,0.37s-0.11,1.09,0.37,1.37c0.48,0.28,1.09,0.11,1.37-0.37 S21.98,18.24,21.5,17.97z"),
        },
