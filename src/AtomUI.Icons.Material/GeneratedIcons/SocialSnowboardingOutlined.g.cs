...
public class SocialSnowboardingOutlined : MaterialIcon
{
    public SocialSnowboardingOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.98, 1, 20.079999999999998, 21.710000000000001);
