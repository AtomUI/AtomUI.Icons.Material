...
public class EditorStrikethroughSTwoTone : MaterialIcon
{
    public EditorStrikethroughSTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3, 2.9999999999999996, 18, 15.009999999999998);
