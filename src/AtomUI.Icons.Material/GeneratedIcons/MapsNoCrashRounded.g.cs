...
public class MapsNoCrashRounded : MaterialIcon
{
    public MapsNoCrashRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3, 0.32000000000000001, 18, 23.68);
