...
public class SocialFloodRounded : MaterialIcon
{
    public SocialFloodRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 2.2000000000000006, 20, 19.830000000000002);
