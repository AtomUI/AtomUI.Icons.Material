...
public class DeviceWifiPasswordRounded : MaterialIcon
{
    public DeviceWifiPasswordRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(0.48999999999999999, 4, 23.510000000000002, 20);
