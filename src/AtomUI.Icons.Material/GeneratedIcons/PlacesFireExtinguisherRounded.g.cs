...
public class PlacesFireExtinguisherRounded : MaterialIcon
{
    public PlacesFireExtinguisherRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(5, 3, 12, 19);
