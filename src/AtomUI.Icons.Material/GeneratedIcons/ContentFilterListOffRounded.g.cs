...
public class ContentFilterListOffRounded : MaterialIcon
{
    public ContentFilterListOffRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.71, 3.1299999999999994, 19.289999999999999, 19.16);
