...
public class ActionViewQuiltTwoTone : MaterialIcon
{
    public ActionViewQuiltTwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M8.33,17H5V7h3.33V17z M13.67,17h-3.33v-4h3.33V17z M19,17h-3.33v-4H19V17z M19,11h-8.67V7H19V11z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
