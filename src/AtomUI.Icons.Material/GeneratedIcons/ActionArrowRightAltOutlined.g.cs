...
public class ActionArrowRightAltOutlined : MaterialIcon
{
    public ActionArrowRightAltOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 8, 16, 8);
