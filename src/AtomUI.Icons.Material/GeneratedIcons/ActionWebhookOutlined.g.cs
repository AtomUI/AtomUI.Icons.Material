...
public class ActionWebhookOutlined : MaterialIcon
{
    public ActionWebhookOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.9999999999999982, 2, 20, 19);
