...
public class SocialScaleRounded : MaterialIcon
{
    public SocialScaleRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.99, 2, 20.02, 20.120000000000001);
