...
public class ImageBedtimeOffOutlined : MaterialIcon
{
    public ImageBedtimeOffOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.3899999999999997, 2.0099999999999998, 19.800000000000001, 20.600000000000001);
