...
public class ImageMotionPhotosPauseRounded : MaterialIcon
{
    public ImageMotionPhotosPauseRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.8900000000000001, 1.8799999999999999, 21.029999999999998, 21.129999999999999);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.1304757418747053, 0, 0, 1.1304757418747053, -1.5657089024964641, -1.5657089024964641);
