...
public class ActionHlsOffRounded : MaterialIcon
{
    public ActionHlsOffRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.7099999999999995, 3.1199999999999997, 19.16, 19.169999999999998);
