...
public class PlacesPoolRounded : MaterialIcon
{
    public PlacesPoolRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.9999999999999947, 2.9900000000000002, 20.000000000000007, 18.030000000000001);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.0909090909090906, 0, 0, 1.0909090909090906, -1.0909090909090864, -1.0909090909090864);
