...
public class HardwareBrowserUpdatedRounded : MaterialIcon
{
    public HardwareBrowserUpdatedRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 3, 19.989999999999998, 18);
