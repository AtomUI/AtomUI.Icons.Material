...
public class ActionManageHistoryRounded : MaterialIcon
{
    public ActionManageHistoryRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3, 3, 20.75, 20.989999999999998);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.0012515644555697, 0, 0, 1.0012515644555697, -0.015018773466836777, -0.015018773466836777);
