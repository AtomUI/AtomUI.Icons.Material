...
public class PlacesWheelchairPickupRounded : MaterialIcon
{
    public PlacesWheelchairPickupRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3, 2, 19.350000000000001, 20);
