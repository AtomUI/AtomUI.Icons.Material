...
public class DeviceStormRounded : MaterialIcon
{
    public DeviceStormRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.2400000000000002, 2, 19.509999999999998, 20);
