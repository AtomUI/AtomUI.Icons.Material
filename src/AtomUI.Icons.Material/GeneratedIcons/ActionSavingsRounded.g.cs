...
public class ActionSavingsRounded : MaterialIcon
{
    public ActionSavingsRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 1.99, 20, 19.010000000000002);
