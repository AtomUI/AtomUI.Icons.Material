...
public class SocialSportsKabaddiRounded : MaterialIcon
{
    public SocialSportsKabaddiRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(0.36999999999999977, 0.37999999999999989, 23.629999999999999, 21.500000000000004);
