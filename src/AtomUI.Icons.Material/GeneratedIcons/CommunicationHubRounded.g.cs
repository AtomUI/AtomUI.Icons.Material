...
public class CommunicationHubRounded : MaterialIcon
{
    public CommunicationHubRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(0, 0, 24, 23);
