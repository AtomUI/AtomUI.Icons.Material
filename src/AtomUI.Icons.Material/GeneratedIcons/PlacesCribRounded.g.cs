...
public class PlacesCribRounded : MaterialIcon
{
    public PlacesCribRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 4, 16.010000000000002, 18);
