...
public class FileDriveFileRenameOutlineTwoTone : MaterialIcon
{
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PolygonDrawingInstruction()
        {
            ...
            Points = [new Avalonia.Point(12.06, 10.02),new Avalonia.Point(5, 17.08),new Avalonia.Point(5, 18),new Avalonia.Point(5.92, 18),new Avalonia.Point(12.98, 10.94)]
        },
        new PolygonDrawingInstruction()
        {
            Opacity = 1,
