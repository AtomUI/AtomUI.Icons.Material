...
public class DeviceWifiTetheringOffOutlined : MaterialIcon
{
    public DeviceWifiTetheringOffOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.3899999999999999, 2.8100000000000001, 20.609999999999999, 19.790000000000003);
