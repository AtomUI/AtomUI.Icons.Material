...
public class EditorAutoGraphRounded : MaterialIcon
{
    public EditorAutoGraphRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.6099999999999999, 2.6299999999999999, 21.120000000000001, 17.530000000000001);
