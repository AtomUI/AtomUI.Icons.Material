...
public class MapsEmergencyOutlined : MaterialIcon
{
    public MapsEmergencyOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.0600000000000001, 2, 19.880000000000003, 20);
