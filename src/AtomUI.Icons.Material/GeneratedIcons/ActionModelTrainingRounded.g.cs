...
public class ActionModelTrainingRounded : MaterialIcon
{
    public ActionModelTrainingRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3, 1.54, 18, 19.460000000000001);
