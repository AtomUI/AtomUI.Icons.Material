...
public class MapsBakeryDiningFilled : MaterialIcon
{
    public MapsBakeryDiningFilled()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.9500000000000002, 7, 18.090000000000003, 9.6700000000000017);
