...
public class MapsStadiumRounded : MaterialIcon
{
    public MapsStadiumRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 2.2000000000000002, 20, 19.68);
