...
public class ActionNewLabelRounded : MaterialIcon
{
    public ActionNewLabelRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 5, 18.670000000000002, 15);
