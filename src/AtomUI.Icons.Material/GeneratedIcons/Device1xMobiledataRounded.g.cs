...
public class Device1xMobiledataRounded : MaterialIcon
{
    public Device1xMobiledataRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 7, 14.510000000000002, 10);
