...
public class DeviceQuizRounded : MaterialIcon
{
    public DeviceQuizRounded()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M17,20H4V7c0-0.55-0.45-1-1-1S2,6.45,2,7v13c0,1.1,0.9,2,2,2h13c0.55,0,1-0.45,1-1S17.55,20,17,20z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
