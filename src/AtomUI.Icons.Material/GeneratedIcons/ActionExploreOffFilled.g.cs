...
public class ActionExploreOffFilled : MaterialIcon
{
    public ActionExploreOffFilled()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 2.0000000000000009, 21, 21);
