...
public class ActionMediationRounded : MaterialIcon
{
    public ActionMediationRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.7, 1, 20.140000000000001, 22.280000000000001);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.0563380281690142, 0, 0, 1.0563380281690142, -0.67605633802817167, -0.67605633802817167);
