...
public class MapsHailRounded : MaterialIcon
{
    public MapsHailRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 2, 15.009999999999998, 20);
