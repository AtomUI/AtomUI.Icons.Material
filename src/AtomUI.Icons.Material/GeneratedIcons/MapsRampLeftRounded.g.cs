...
public class MapsRampLeftRounded : MaterialIcon
{
    public MapsRampLeftRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(8.3200000000000003, 3.3199999999999998, 10.239999999999998, 17.68);
