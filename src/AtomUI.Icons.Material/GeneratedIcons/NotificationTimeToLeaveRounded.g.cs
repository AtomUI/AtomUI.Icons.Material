...
public class NotificationTimeToLeaveRounded : MaterialIcon
{
    public NotificationTimeToLeaveRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3.0000000000000004, 4, 18, 16);
