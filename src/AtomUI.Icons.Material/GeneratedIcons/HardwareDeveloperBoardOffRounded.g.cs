...
public class HardwareDeveloperBoardOffRounded : MaterialIcon
{
    public HardwareDeveloperBoardOffRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 2.4199999999999999, 21, 20.57);
