...
public class PlacesNoBackpackRounded : MaterialIcon
{
    public PlacesNoBackpackRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.71, 2, 19.169999999999998, 20.289999999999999);
