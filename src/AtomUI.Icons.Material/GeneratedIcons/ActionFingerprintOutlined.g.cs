...
public class ActionFingerprintOutlined : MaterialIcon
{
    public ActionFingerprintOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.9299999999999997, 2, 18.129999999999999, 20.000000000000004);
