...
public class AvSlowMotionVideoRounded : MaterialIcon
{
    public AvSlowMotionVideoRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.1000000000000001, 2.1000000000000005, 19.899999999999999, 19.789999999999999);
