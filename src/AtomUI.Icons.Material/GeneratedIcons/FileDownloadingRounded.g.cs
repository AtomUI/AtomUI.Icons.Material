...
public class FileDownloadingRounded : MaterialIcon
{
    public FileDownloadingRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 2.1099999999999999, 19.899999999999999, 19.789999999999999);
