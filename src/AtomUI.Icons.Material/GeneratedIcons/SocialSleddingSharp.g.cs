...
public class SocialSleddingSharp : MaterialIcon
{
    public SocialSleddingSharp()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 2.5, 22.469999999999999, 20.980000000000004);
