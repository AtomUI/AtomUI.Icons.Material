...
public class SocialPianoOffTwoTone : MaterialIcon
{
    public SocialPianoOffTwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M8.25,19H5V7.83l2,2v3.67c0,0.55,0.45,1,1,1h0.25V19z M9.75,19v-4.5H10c0.46,0,0.82-0.31,0.94-0.73l3.31,3.31 V19H9.75z M13,10.17V5h-2v3.17L13,10.17z M19,16.17V5h-2v8.5c0,0.19-0.07,0.36-0.16,0.51L19,16.17z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
