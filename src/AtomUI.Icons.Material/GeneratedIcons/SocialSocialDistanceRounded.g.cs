...
public class SocialSocialDistanceRounded : MaterialIcon
{
    public SocialSocialDistanceRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 3, 20, 17.460000000000001);
