...
public class SocialSurfingRounded : MaterialIcon
{
    public SocialSurfingRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 1.5, 20, 21.77);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.1004126547455297, 0, 0, 1.1004126547455297, -1.2049518569463569, -1.2049518569463569);
