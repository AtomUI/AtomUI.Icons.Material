...
public class MapsPestControlRodentRounded : MaterialIcon
{
    public MapsPestControlRodentRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.8600000000000001, 3, 20.879999999999999, 18);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.1142061281337046, 0, 0, 1.1142061281337046, -1.3704735376044539, -1.3704735376044539);
