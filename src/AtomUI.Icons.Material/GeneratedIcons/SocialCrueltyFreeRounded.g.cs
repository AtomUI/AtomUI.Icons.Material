...
public class SocialCrueltyFreeRounded : MaterialIcon
{
    public SocialCrueltyFreeRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(5, 2, 14, 19.5);
