...
public class SocialSkateboardingOutlined : MaterialIcon
{
    public SocialSkateboardingOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3, 1, 17, 23);
