...
public class ActionVisibilityOffTwoTone : MaterialIcon
{
    public ActionVisibilityOffTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 2.4500000000000002, 22, 19.150000000000002);
