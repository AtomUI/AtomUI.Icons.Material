...
public class MapsMiscellaneousServicesSharp : MaterialIcon
{
    public MapsMiscellaneousServicesSharp()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.8999999999999999, 2, 20.190000000000005, 20.009999999999998);
