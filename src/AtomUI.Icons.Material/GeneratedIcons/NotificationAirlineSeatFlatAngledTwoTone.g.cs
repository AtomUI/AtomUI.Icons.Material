...
public class NotificationAirlineSeatFlatAngledTwoTone : MaterialIcon
{
    public NotificationAirlineSeatFlatAngledTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.5, 4.5, 21.52, 14.5);
