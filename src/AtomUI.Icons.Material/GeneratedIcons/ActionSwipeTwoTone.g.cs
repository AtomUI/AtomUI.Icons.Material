...
public class ActionSwipeTwoTone : MaterialIcon
{
    public ActionSwipeTwoTone()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        ...
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M12,13.68V7.5C12,7.22,11.78,7,11.5,7S11,7.22,11,7.5v10.61l-4.17-0.89 l3.7,3.78h6.55L18,15.56l-4.24-1.89H12z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
