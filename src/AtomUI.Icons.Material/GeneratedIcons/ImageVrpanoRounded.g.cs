...
public class ImageVrpanoRounded : MaterialIcon
{
    public ImageVrpanoRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 3.8399999999999999, 20, 16.330000000000002);
