...
public class AvQueuePlayNextRounded : MaterialIcon
{
    public AvQueuePlayNextRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 3, 22.68, 19.16);
