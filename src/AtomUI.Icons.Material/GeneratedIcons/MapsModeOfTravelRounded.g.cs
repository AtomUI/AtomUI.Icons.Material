...
public class MapsModeOfTravelRounded : MaterialIcon
{
    public MapsModeOfTravelRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 2, 18.960000000000001, 19.749999999999996);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.1406844106463878, 0, 0, 1.1406844106463878, -1.6882129277566538, -1.6882129277566538);
