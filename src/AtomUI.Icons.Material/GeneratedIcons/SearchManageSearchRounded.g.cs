...
public class SearchManageSearchRounded : MaterialIcon
{
    public SearchManageSearchRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 5.5, 19.689999999999998, 13.5);
