...
public class PlacesDoNotStepTwoTone : MaterialIcon
{
    public PlacesDoNotStepTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1, 2, 22, 20.609999999999999);
