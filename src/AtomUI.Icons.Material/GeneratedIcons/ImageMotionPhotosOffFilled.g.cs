...
public class ImageMotionPhotosOffFilled : MaterialIcon
{
    public ImageMotionPhotosOffFilled()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.8899999999999999, 2, 20.109999999999999, 20.120000000000001);
