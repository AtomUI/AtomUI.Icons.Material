...
public class ImageCameraRounded : MaterialIcon
{
    public ImageCameraRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.6999999999999997, 1.75, 20.600000000000001, 20.510000000000002);
