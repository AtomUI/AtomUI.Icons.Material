...
public class MapsDesignServicesOutlined : MaterialIcon
{
    public MapsDesignServicesOutlined()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.8399999999999999, 2.6399999999999992, 18.52, 18.68);
