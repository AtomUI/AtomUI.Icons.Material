...
public class SocialPersonOffTwoTone : MaterialIcon
{
    public SocialPersonOffTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.3899999999999999, 2.8099999999999996, 19.800000000000001, 19.790000000000003);
