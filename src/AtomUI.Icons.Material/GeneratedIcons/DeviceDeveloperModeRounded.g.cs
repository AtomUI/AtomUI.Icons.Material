...
public class DeviceDeveloperModeRounded : MaterialIcon
{
    public DeviceDeveloperModeRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4.3100000000000005, 1, 15.369999999999999, 22);
