...
public class SocialDeckFilled : Icon
{
    public SocialDeckFilled()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PolygonDrawingInstruction()
        {
            ...
            Points = [new Point(22, 9),new Point(12, 2),new Point(2, 9),new Point(11, 9),new Point(11, 22),new Point(13, 22),new Point(13, 9)]
        },
        new PolygonDrawingInstruction()
        {
            Opacity = 1,
