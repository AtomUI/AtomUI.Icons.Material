...
public class SocialAssistWalkerRounded : MaterialIcon
{
    public SocialAssistWalkerRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.4100000000000001, 2.5, 18.09, 18.02);
