...
public class ImageWbAutoRounded : MaterialIcon
{
    public ImageWbAutoRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(0, 4, 23.679999999999996, 16);
