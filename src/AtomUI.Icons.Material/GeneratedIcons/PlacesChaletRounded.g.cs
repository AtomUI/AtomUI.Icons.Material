...
public class PlacesChaletRounded : MaterialIcon
{
    public PlacesChaletRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.8199999999999998, 3, 19.18, 17);
