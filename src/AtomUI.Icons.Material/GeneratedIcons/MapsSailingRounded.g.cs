...
public class MapsSailingRounded : MaterialIcon
{
    public MapsSailingRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 1.0700000000000001, 20, 22.199999999999999);
