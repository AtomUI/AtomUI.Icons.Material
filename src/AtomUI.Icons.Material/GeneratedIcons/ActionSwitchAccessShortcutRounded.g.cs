...
public class ActionSwitchAccessShortcutRounded : MaterialIcon
{
    public ActionSwitchAccessShortcutRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3, 2, 16, 19.66);
