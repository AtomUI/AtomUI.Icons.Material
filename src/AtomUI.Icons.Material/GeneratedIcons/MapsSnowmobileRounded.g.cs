...
public class MapsSnowmobileRounded : MaterialIcon
{
    public MapsSnowmobileRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(-0.77000000000000002, 5, 24.759999999999998, 15);
