...
public class SocialVaccinesTwoTone : MaterialIcon
{
    public SocialVaccinesTwoTone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 2, 19, 20.5);
