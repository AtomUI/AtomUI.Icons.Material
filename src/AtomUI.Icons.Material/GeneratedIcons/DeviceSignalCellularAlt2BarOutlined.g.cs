...
public class DeviceSignalCellularAlt2BarOutlined : MaterialIcon
{
    public DeviceSignalCellularAlt2BarOutlined()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M5,14h3v6H5V14z M11,9h3v11h-3V9z"),
        },
    ];
