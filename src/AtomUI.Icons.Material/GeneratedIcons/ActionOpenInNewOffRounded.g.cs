...
public class ActionOpenInNewOffRounded : MaterialIcon
{
    public ActionOpenInNewOffRounded()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(1.71, 3, 19.289999999999999, 19.289999999999999);
